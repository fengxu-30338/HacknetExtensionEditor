...
## v0.5.0更新日志-2026-02-10

新增在Hacknet中定位绘制元素界面调用栈的功能

## v0.4.8更新日志-2026-02-08

新增打印当前游戏中的OS信息与计算机信息功能

## v0.4.3更新日志-2026-02-04

新增在编辑器中显示标签的作用描述功能
![](imgs/tagdesc.png)

如果您已经是一名资深的Hacknet扩展开发者，您可以在设置中关闭该功能，以提高编辑器的性能。
